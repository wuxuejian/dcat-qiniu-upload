<style>
    ...
    .web-qn-uploader .placeholder .flashTip a {
        color: @primary(-10);
    }

    .web-qn-uploader .statusBar .upload-progress span.percentage,
    .web-qn-uploader .filelist li p.upload-progress span {
        background: @primary(-8);
    }

    .web-qn-uploader .dnd-area.webuploader-dnd-over {
        border: 3px dashed #999 !important;
    }
    .web-qn-uploader .dnd-area.webuploader-dnd-over .placeholder {
        border: none;
    }
...
<div class="{{$viewClass['form-group']}} {{ $class }}">
    ...
    <div class="{{$viewClass['field']}}">
        ...
        <div class="web-qn-uploader {{ $fileType }}">
...
console.log('{!! $selector !!}')
    ...
    function init() {
        ...
        opts.upload = $.extend({
            ...
            paste: $this.find('.web-qn-uploader')
        }, opts);

        uploader = Dcat.QnUploader(opts);
        uploader.build();
        uploader.preview();
